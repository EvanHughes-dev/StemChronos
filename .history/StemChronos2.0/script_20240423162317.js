...
async function SetSchedule(Schedule) {
  ...
  switch (DayOfWeek) {
    case 2:
      currentData = currentData.Monday;
      break;
    case 3:
      currentData = currentData.Tuesday;
    case 4:
      currentData = currentData.Wednesday;
      break;
    case 5:
      currentData = currentData.Thursday;
    case 6:
      currentData = currentData.Friday;
  }
  let hour = d.getHours();
